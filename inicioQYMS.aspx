<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inicioQYMS.aspx.cs" Inherits="inicioQMGPS" %>
    ...
    <div class="container-fluid" style="width: 100%!important; padding-left:0px!important">
        ...
        <div class="row">
            ...
            <div class="col-xs-10 col-sm-8 col-md-6 col-lg-4">
                ...
                <asp:Panel ID="PT" runat="server" DefaultButton="BtnTransporte">
                    <div id="LTransporte" class="jumbotron" style="background: rgba(29,81,143, 0.6)!important;">
                        <div class="container">
                            ...
                            <div class="form-group">
                                <label for="Contraseña">
                                    Cliente:</label>
                                <input type="text" class="form-control" id="ClienteT" runat="server" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 linea">
                            </div>
                            <center>
                                <asp:UpdatePanel ID="UPT" runat="server">
                                    <ContentTemplate>
                                        <asp:Button ID="BtnTransporte" runat="server" CssClass="btn btn-primary ButtonColor"
                                            Text="Ingresar" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </center>
