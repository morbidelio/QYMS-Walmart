<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Control_MovimientosV2.aspx.cs" Inherits="App_Control_Movimientos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Filtro" runat="Server">
    <asp:UpdatePanel runat="server" ID="updbuscar">
        ...
        <br />
            ...
            <div class="col-xs-1">
                <br />
                <asp:LinkButton ID="btn_buscar" OnClick="btn_buscarMovimientos_Click" CssClass="btn btn-primary" ClientIDMode="Static" ToolTip="Buscar Movimientos" runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="Contenedor" runat="Server">
    <div class="col-xs-12">
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>
                <asp:GridView ID="gv_listar" runat="server" CellPadding="8" AllowSorting="true" Width="100%" CssClass="table table-bordered table-hover tablita"
