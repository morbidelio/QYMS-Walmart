...
public partial class App_Reporte_Entrada : System.Web.UI.Page
{
    ...
    protected void btnExportar_Click(object sender, EventArgs e)
    {
        ...
        string fileName = "Reporte_Entrada.xls";
    ...
    private void ObtenerReporte(bool forzarBD)
    {
        if (this.ViewState["listar"] == null || forzarBD)
        {
            ...
            this.ViewState["listar"] = r.CargarEntradas(site_id, desde, hasta);
        }
