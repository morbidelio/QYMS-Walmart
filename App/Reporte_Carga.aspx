<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Reporte_Carga.aspx.cs" Inherits="App_Reporte_Carga" %>
      ...
      <ContentTemplate>
        <asp:GridView ID="gv_listar" runat="server" CellPadding="8" AllowPaging="false" GridLines="Horizontal" DataKeyNames="ID_SOLICITUD,ID_SOLICITUDANDEN,ORDEN" Width="100%"
          ...
          <Columns>
            ...
            <asp:TemplateField HeaderText="Carga Parcial" ShowHeader="False" ItemStyle-Width="5%" Visible="false" ItemStyle-HorizontalAlign="Center"
                               HeaderStyle-HorizontalAlign="Center">
              <ItemTemplate>
