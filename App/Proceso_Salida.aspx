<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Proceso_Salida.aspx.cs" Inherits="App_Proceso_Salida" %>

<asp:Content ID="Content1" ContentPlaceHolderID="titulo" runat="Server">
    <div class="col-xs-12 separador"></div>
    <h2>Proceso de Salida
    </h2>
</asp:Content>
    ...
    <asp:UpdatePanel runat="server" ID="upfiltro">
        <ContentTemplate>
            <div class="col-lg-2 col-xs-4">
                Patente:
    <br />
                <asp:TextBox ID="txt_Patente" runat="server" CssClass="tb1 textbox form-control" MaxLength="14" Width="90px" />
            </div>
            <div class="col-lg-2 col-xs-4">
                Flota:
    <br />
                <asp:TextBox ID="txt_NroFlota" runat="server" CssClass="tb1 textbox form-control" MaxLength="14" Width="90px" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
            ...
            <div id="dv_contenido" runat="server" style="display: none;">
                <div class="col-xs-12" style="height: 60vh; overflow: auto">
                    <div class="col-lg-6 col-xs-12">
                            ...
                            <div class="col-lg-7 col-xs-12 text-left" style="text-align: center;">
                                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                    <ContentTemplate>
                                        <table class="table table-bordered table-hover" runat="server" id="tbl_datosTracto">
                                            <tr>
                                                <td class="tablita">PATENTE TRACTO:
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="tablita">RUT CONDUCTOR:
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="tablita">NOMBRE CONDUCTOR:
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="tablita">TRANSPORTISTA:
                                                </td>
                                                <td>
