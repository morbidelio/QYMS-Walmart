<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Playa_Origen_Destino_TIPO_CARGA.aspx.cs" Inherits="Playa_Origen_Destino_TIPO_CARGA" %>
<asp:Content ID="Titulo" ContentPlaceHolderID="titulo" Runat="Server">
  <div class="col-xs-12 separador">
  </div>
  <h2>
            Ingreso por Tipo de Carga
  </h2>
</asp:Content>
                ...
                <div class="col-xs-6" style="overflow-y:scroll;height:250px">
                  <asp:GridView id="gv_seleccionados" CssClass="table table-bordered table-hover tablita" AutoGenerateColumns="false" EmptyDataText="No hay playas seleccionadas!"
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="TIIC_ID" visible="false" />
                       <asp:BoundField DataField="TIPO_CARGA" HeaderText="CARGA" />
                    </Columns>
                  </asp:GridView>
                </div>
              </div>
