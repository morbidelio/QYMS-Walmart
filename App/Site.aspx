<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Site.aspx.cs" Inherits="App_Site" %>
...
<asp:Content ID="Filtro" ContentPlaceHolderID="Filtro" runat="Server">
    ...
    <div class="col-lg-1">
        <br />
        <asp:LinkButton ID="btn_buscarSite" OnClick="btn_buscarSite_Click" CssClass="btn btn-primary" ToolTip="Buscar Cliente" runat="server">
      <span class="glyphicon glyphicon-search" />
        </asp:LinkButton>
        <asp:LinkButton ID="btn_nuevoSite" CssClass="btn btn-primary" ToolTip="Nuevo Site" runat="server" OnClick="btn_nuevoSite_Click">
                ...
                <asp:GridView ID="gv_listar" runat="server" AllowPaging="True" AllowSorting="True" PageSize="8"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderStyle-Width="1%" ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="btn_modificarSite" runat="server" CommandName="EDITAR" CommandArgument='<%# Eval("ID") %>' CssClass="btn btn-sm btn-primary" ToolTip="Modificar">
                  <span class="glyphicon glyphicon-pencil" />
                        ...
                        <asp:TemplateField HeaderStyle-Width="1%" ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="btn_virtualSite" runat="server" CommandName="VIRTUAL" CommandArgument='<%# Eval("ID") %>' CssClass="btn btn-sm btn-primary" ToolTip="Asignar Virtual">
                  <span class="glyphicon glyphicon-alert" />
                        ...
                        <asp:TemplateField HeaderStyle-Width="1%" ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="btn_eliminarSite" runat="server" CommandName="ELIMINAR" CommandArgument='<%# Eval("ID") %>' CssClass="btn btn-sm btn-primary" ToolTip="Eliminar">
                  <span class="glyphicon glyphicon-remove" />
                        ...
                        <asp:TemplateField HeaderStyle-Width="1%" ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="btn_trailerAuto" runat="server" CommandName="ACTIVAR" CommandArgument='<%# Eval("ID") %>' CssClass="btn btn-sm btn-primary" ToolTip="Auto/Manual">
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                    <ContentTemplate>
                        <div class="modal-header">
                            <h4 class="modal-title">Datos Site
                            </h4>
                        </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <asp:LinkButton ID="btnModalEliminar" runat="server" OnClick="btn_EliminarSite_Click" CssClass="btn btn-primary" ToolTip="Eliminar">
