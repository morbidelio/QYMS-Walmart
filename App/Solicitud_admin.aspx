...
CodeFile="Solicitud_admin.aspx.cs" Inherits="App_soli_ADMIN" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Titulo" ContentPlaceHolderID="titulo" runat="Server">
  <div class="col-xs-12 separador">
  </div>
  <h2>
    Maestro Trailer Logística Inversa
  </h2>
</asp:Content>
      ...
      <asp:Panel ID="SITE" runat="server" >
        <div class="col-xs-7 col-lg-2">
          ...
          <asp:DropDownList runat="server" id="dropsite" ClientIDMode="Static" cssclass="form-control"
                            AutoPostBack="true" OnSelectedIndexChanged="drop_SelectedIndexChanged"  Width="90%"></asp:DropDownList>
        </div>
      </asp:Panel>
      <div class="col-xs-2">
        Tipo Transporte
