<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Control_Carga_New_6009.aspx.cs" Inherits="App_Control_Carga_New_6009" %>
                ...
                <asp:GridView ID="gv_listar" runat="server" DataKeyNames="ID_SOLICITUD,ID_LUGAR,ORDEN" CssClass="table table-bordered table-hover tablita" EmptyDataText="No Existen Movimientos Asignados!" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Editar" ItemStyle-Width="1%">
                            <ItemTemplate>
                                <asp:LinkButton ID="btn_editar" runat="server" CommandName="Edit" CssClass="btn btn-sm btn-primary" ToolTip="Modificar" CommandArgument='<%# Container.DataItemIndex %>'>
                  <span class="glyphicon glyphicon-pencil" />
                                </asp:LinkButton>
                                <asp:LinkButton ID="btn_AndenEmergencia" runat="server" CommandName="AndenEmergencia" CssClass="btn btn-sm btn-primary" ToolTip="Anden Emergencia" CommandArgument='<%# Container.DataItemIndex %>'>
                  <span class="glyphicon glyphicon-pause" />
                                </asp:LinkButton>
                                <asp:LinkButton ID="btn_locales" runat="server" CommandName="Locales" CssClass="btn btn-sm btn-primary" ToolTip="Locales" CommandArgument='<%# Container.DataItemIndex %>'>
                  <span class="glyphicon glyphicon-plus" />
                                </asp:LinkButton>
                                <asp:LinkButton ID="btn_encendido" runat="server" CommandName="encender" CssClass="btn btn-sm btn-primary" ToolTip="Encender Frio" CommandArgument='<%# Container.DataItemIndex %>'>
                  <span class="glyphicon glyphicon-off" />
                        ...
                        <asp:BoundField ReadOnly="True" HeaderText="ID Shortrec Sol." DataField="ID_SHORTEK" SortExpression="ID_SHORTEK" Visible="false" />
                         <asp:BoundField ReadOnly="True" HeaderText="ID Shortrec Trai." DataField="ID_SHORTEK_trailer" SortExpression="ID_SHORTEK_asignado" Visible="false" />
                        ...
                        <asp:BoundField ReadOnly="True" HeaderText="Tiempo en carga" DataField="TIEMPO_CARGA" SortExpression="TIEMPO_CARGA" Visible="false" />
                        <asp:BoundField ReadOnly="True" HeaderText="ID Ruta" DataField="SOLI_RUTA" SortExpression="SOLI_RUTA" />
                        <asp:BoundField ReadOnly="True" HeaderText="Estado Solicitud" DataField="ESTADOSOLICITUD" SortExpression="ESTADOSOLICITUD" Visible="false" />
                        <asp:BoundField ReadOnly="True" HeaderText="Fecha Creación" DataField="SOLI_FH_CREACION" SortExpression="SOLI_FH_CREACION_2" Visible="false" />
                        ...
                        <asp:BoundField ReadOnly="True" HeaderText="Fecha Andén" DataField="FECHA_RESERVA_ANDEN" SortExpression="FECHA_RESERVA_ANDEN_2" Visible="false" />
                        <asp:BoundField ReadOnly="True" HeaderText="Local" DataField="LOCALES" SortExpression="LOCALES" />
                        <asp:BoundField ReadOnly="True" HeaderText="Regiones" DataField="REGIONES" SortExpression="REGIONES" Visible="false" />
                        <asp:BoundField ReadOnly="True" HeaderText="Transporte" DataField="TRANSPORTISTA" SortExpression="TRANSPORTISTA" Visible="false" />
                        ...
                        <asp:BoundField ReadOnly="True" HeaderText="Plancha" DataField="Plancha" SortExpression="Plancha" Visible="false" />
                        ...
                        <asp:BoundField ReadOnly="True" HeaderText="Tipo Carga" DataField="FRIO" SortExpression="FRIO" Visible="false" />
                        ...
                        <asp:BoundField ReadOnly="True" HeaderText="jornada" DataField="jornada" SortExpression="jornada" Visible="false" />
                        <asp:TemplateField HeaderText="Carga" ShowHeader="False" ItemStyle-Width="1%">
                            <ItemTemplate>
                                <asp:LinkButton ID="btn_cargado" runat="server" CausesValidation="True" CommandName="Cargado" CssClass="btn btn-sm btn-primary" ToolTip="Completar Carga" CommandArgument='<%# Container.DataItemIndex %>'>
                  <span class="glyphicon glyphicon-check" />
                                </asp:LinkButton>
                                <asp:LinkButton ID="btn_sello" runat="server" CausesValidation="True" CommandName="colocar_sello" CssClass="btn btn-sm btn-primary" ToolTip="Sello" CommandArgument='<%# Container.DataItemIndex %>'>
                  <span class="glyphicon glyphicon-arrow-down" />
                                </asp:LinkButton>
                                <asp:LinkButton ID="btn_valida_sello" runat="server" CausesValidation="True" CommandName="validar_sello" CssClass="btn btn-sm btn-primary" ToolTip="A Estacionamiento" CommandArgument='<%# Container.DataItemIndex %>'>
                  <span class="glyphicon glyphicon-arrow-up" />
                        ...
                        <asp:TemplateField HeaderText="Parcial" ItemStyle-Width="1%" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="btn_cargaParcial" runat="server" CommandName="Parcial" CssClass="btn btn-sm btn-primary" ToolTip="Interrumpir Carga" CommandArgument='<%# Container.DataItemIndex %>'>
                  <span class="glyphicon glyphicon-pause" />
                                </asp:LinkButton>
                                <asp:LinkButton ID="btn_cargaContinuar" Visible="false" runat="server" CommandName="Continuar" CssClass="btn btn-sm btn-primary" ToolTip="Continuar Carga" CommandArgument='<%# Container.DataItemIndex %>'>
                  <span class="glyphicon glyphicon-play" />
                        ...
                        <asp:TemplateField HeaderText="Cancelar" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="btn_solicitudCancelar" runat="server" CommandName="CANCELAR" CssClass="btn btn-sm btn-primary" ToolTip="Cancelar Solicitud" CommandArgument='<%# Container.DataItemIndex %>'>
