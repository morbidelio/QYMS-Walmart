<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Panel_Control_TV.aspx.cs" Inherits="App_Panel_Control" %>
<asp:Content ID="Content2" ContentPlaceHolderID="Filtro" Runat="Server">
  <asp:UpdatePanel runat="server" ID="upfiltros" >
    <ContentTemplate>
      <%--      <div class="col-xs-10">
        <asp:LinkButton runat="server" ID="maximizar" OnClientClick="Extender_Panel_Control()" >Maximizar  </asp:LinkButton>  
      </div>--%>
      ...
      <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
        ...
        <button class="btn btn-primary" type="button"   onclick="javascript:window.location.href = './inicio.aspx'" >
        Inicio
      </button>
      ...
      <div class="collapse" id="collapseExample">
        ...
        <asp:Panel ID="SITE" runat="server" >
          ...
          <asp:Button ID="btn_buscar" CssClass="btn btn-primary" runat="server" 
