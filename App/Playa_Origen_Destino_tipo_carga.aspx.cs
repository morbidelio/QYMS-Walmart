...
public partial class Playa_Origen_Destino_TIPO_CARGA : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            utils.CargaDrop(ddl_destinoTipoCarga, "ID", "DESCRIPCION", y.obtenerTipoCarga(null));
            ObtenerPlaya(true);
        }
    }
    ...
    {
        PlayaOrigenDestinoTipoCargaBC plod = new PlayaOrigenDestinoTipoCargaBC();
        DataTable dt = (DataTable)ViewState["seleccionados"];
        if (plod.Crear(dt, int.Parse(hf_idPlaya.Value), int.Parse(ddl_destinoTipoCarga.SelectedValue)))
        {
