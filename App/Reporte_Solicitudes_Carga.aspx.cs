...
public partial class App_Reporte_Solicitudes_Carga : System.Web.UI.Page
{
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        if (view.Count > 0)
        {
            ...
            string fileName = "Reporte_Solicitudes_Carga.xls";
    ...
    private void ObtenerReporte(bool forzarBD)
    {
        if (this.ViewState["listar"] == null || forzarBD)
        {
            ...
            int estado = Convert.ToInt32(this.ddl_buscarEstado.SelectedValue.ToString());
            ReportBC r = new ReportBC();
            this.ViewState["listar"] = r.CargarSolicitudesCarga(site_id, desde, hasta, estado);
        }
