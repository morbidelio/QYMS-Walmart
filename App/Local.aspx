<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Local.aspx.cs" Inherits="App_Local" %>
...
<asp:Content ID="Filtro" ContentPlaceHolderID="Filtro" Runat="Server">
  ...
  <div class="col-xs-2">
    ...
    <asp:LinkButton ID="btn_nuevoLocal" CssClass="btn btn-primary" ToolTip="Nuevo Local"
