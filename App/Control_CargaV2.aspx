<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Control_CargaV2.aspx.cs" Inherits="App_Control_Cargav2" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
      <ContentTemplate>
        <asp:GridView ID="gv_listar" runat="server" CellPadding="8" AllowPaging="false" GridLines="Horizontal" DataKeyNames="ID_SOLICITUD,ID_SOLICITUDANDEN,ORDEN" Width="100%"
                      ...
                      AllowSorting="True" EnableSortingAndPagingCallbacks="false" UseAccessibleHeader="true" OnSorting="gv_listar_Sorting"
                      OnRowDataBound="gv_listar_RowDataBound" OnRowCreated="gv_listar_RowCreated" OnRowCommand="gv_listar_RowCommand">
          <Columns>
            ...
            <asp:TemplateField HeaderText="Carga" ShowHeader="False" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center"
                               HeaderStyle-HorizontalAlign="Center">
              <ItemTemplate>
                <asp:LinkButton ID="btn_cargado" runat="server" CausesValidation="True" CommandName="Cargado"
                                CssClass="btn btn-sm btn-primary" ToolTip="Completar Carga" CommandArgument='<%# Eval("ID_SOLICITUD") + ";" + Eval("ID_LUGAR")+ ";" + Eval("orden") %>'>
                  <span class="glyphicon glyphicon-check"></span>
                </asp:LinkButton>

                <asp:LinkButton ID="btn_sello" runat="server" CausesValidation="True" CommandName="colocar_sello" 
                                CssClass="btn btn-sm btn-primary" ToolTip="Sello" CommandArgument='<%# Eval("ID_SOLICITUD") + ";" + Eval("ID_LUGAR")+ ";" + Eval("orden") %>'>
                  <span class="glyphicon glyphicon-arrow-down"></span>
                </asp:LinkButton>

                <asp:LinkButton ID="btn_valida_sello" runat="server" CausesValidation="True" CommandName="validar_sello" 
                                CssClass="btn btn-sm btn-primary" ToolTip="A Estacionamiento" CommandArgument='<%# Eval("ID_SOLICITUD") + ";" + Eval("ID_LUGAR")+ ";" + Eval("orden") %>'>
            ...
            <asp:TemplateField HeaderText="Parcial" ShowHeader="False" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center"
                               HeaderStyle-HorizontalAlign="Center">
              <ItemTemplate>
                <asp:LinkButton ID="btn_cargaParcial" runat="server" CausesValidation="False" CommandName="Parcial"
                                CssClass="btn btn-sm btn-primary" ToolTip="Interrumpir Carga" CommandArgument='<%# Eval("ID_SOLICITUD") + ";" + Eval("ID_LUGAR")+ ";" + Eval("orden") %>'>
                  <span class="glyphicon glyphicon-pause"></span>
                </asp:LinkButton>
                <asp:LinkButton ID="btn_cargaContinuar" Visible="false" runat="server" CausesValidation="False" CommandName="Continuar"
                                CssClass="btn btn-sm btn-primary" ToolTip="Continuar Carga" CommandArgument='<%# Eval("ID_SOLICITUD") + ";" + Eval("ID_LUGAR")+ ";" + Eval("orden") %>'>
                  <span class="glyphicon glyphicon-play"></span>
                </asp:LinkButton>
              </ItemTemplate>
              <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Editar" ShowHeader="False" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center"
                               HeaderStyle-HorizontalAlign="Center">
              <ItemTemplate>
                <asp:LinkButton ID="btn_editar" runat="server" CausesValidation="True" CommandName="Edit"
                                CssClass="btn btn-sm btn-primary" ToolTip="Modificar" Text="Modificar" CommandArgument='<%# Eval("ID_SOLICITUD") + ";" + Eval("ID_LUGAR")+ ";" + Eval("orden") %>'>
              ...
              <div class="col-xs-12 container-fluid" style="overflow:auto;height:45vh;">
                ...
                <asp:GridView ID="gv_solLocales" runat="server" CellPadding="8" GridLines="Horizontal" OnRowCommand="gv_solLocales_RowCommand" OnRowDataBound="gv_solLocales_rowDataBound"
                  ...
                  <Columns>
                    ...
                    <asp:BoundField ReadOnly="True" HeaderText="Orden Andén" DataField="SOAN_ORDEN" SortExpression="SOAN_ORDEN" Visible="false"></asp:BoundField>
                    <asp:BoundField ReadOnly="True" HeaderText="Orden Local" DataField="ORDEN" SortExpression="ORDEN" Visible="false"></asp:BoundField>
                    ...
                    <asp:BoundField ReadOnly="True" HeaderText="ID Estado" DataField="SOES_ID" SortExpression="SOES_ID" Visible="false"></asp:BoundField>
                  </Columns>
                </asp:GridView>
        ...
        <ContentTemplate>
          <div class="modal-content">
            ...
            <div class="modal-body">
              Se eliminará el local de la base de datos ¿Desea continuar?
            </div>
            <div class="modal-footer">
              <asp:LinkButton ID="btn_confirmar" runat="server" 
                              CssClass="btn btn-primary" OnClick="btn_confirmar_Click">
