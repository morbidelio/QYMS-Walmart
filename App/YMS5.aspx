<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Master/MasterTms.master" CodeFile="YMS5.aspx.cs" EnableViewState="true" 
    Inherits="yms4"   %>
...
<asp:Content ID="Contenido" ContentPlaceHolderID="Contenedor" Runat="Server" ClientIDMode="Static">
   ...
   <asp:Button runat="server" ClientIDMode="Static" ID="zin" OnClientClick="zoomIn();"   Text="Zoom In" Visible="false" />
    ...
    <asp:Image ID="zoomOut" runat="server" ClientIDMode="Static"   ImageUrl="~/images/iconos/close.png"   />
