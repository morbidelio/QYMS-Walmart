...
public partial class App_Reporte_Entrada_salida : System.Web.UI.Page
{
    ...
    protected void btnExportar_Click(object sender, EventArgs e)
    {
        ...
        string fileName = "Reporte_Mudanza.xls";
    ...
    private void ObtenerReporte(bool forzarBD)
    {
        if (this.ViewState["listar"] == null || forzarBD)
        {
            ...
            this.ViewState["listar"] = r.Reporte_Entradaysalida (site_id, desde, hasta, txtplaca.Text, txt_rut.Text, int.Parse(ddl_buscarTransportista.SelectedValue) );
        }
