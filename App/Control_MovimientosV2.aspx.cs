...
public partial class App_Control_Movimientos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.IsPostBack)
        {
            ...
            this.utils.CargaDropTodos(this.ddl_buscarRemolcador, "ID", "CODIGO", r.obtenerTodos(int.Parse(this.ddl_buscarSite.SelectedValue)));
