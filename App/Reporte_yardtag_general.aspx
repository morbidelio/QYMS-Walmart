<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Reporte_yardtag_general.aspx.cs" Inherits="App_Reporte_yardtag_general" %>

<asp:Content ID="Content1" ContentPlaceHolderID="titulo" Runat="Server">
  <div class="col-xs-12 separador"></div>
  <h2>Reporte Yardtag General</h2>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Filtro" Runat="Server">
  ...
  <div class="col-xs-1">
    ...
    <div class="col-lg-2">
                  Zona
                  <br />
                  <asp:DropDownList ID="ddl_Zona" CssClass="form-control" OnSelectedIndexChanged="ddl_editZona_IndexChanged" runat="server" AutoPostBack="true">
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
      <asp:GridView ID="gv_listar" onsorting="gv_listar_Sorting" OnRowCreated="gv_listar_RowCreated" AllowSorting="true"
                    ...
                    CssClass="table table-bordered table-hover tablita" AutoGenerateColumns="true" runat="server" >
        <Columns>
