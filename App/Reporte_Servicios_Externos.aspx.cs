...
public partial class App_Reporte_servicios_externos : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.IsPostBack)
        {
            ProveedorBC tran = new ProveedorBC();
            this.utils.CargaDrop(this.ddl_buscarTransportista, "ID", "DESCRIPCION", tran.obtenerTodo());
   ...
   {
       this.ObtenerServiciosExternos(true);
   }
    ...
    protected void gv_listar_Sorting(object sender, GridViewSortEventArgs e)
    {
        ...
        this.ObtenerServiciosExternos(false);
    }
    ...
    protected void btnExportar_Click(object sender, EventArgs e)
    {
        ...
        //BoundField site_in =new BoundField();
        //site_in.DataField = "SITE_IN";
        //site_in.HeaderText = "En CD";
        //gv.Columns.Add(site_in );
        gv.DataSource = view;
        gv.DataBind();

        string fileName = "reporte_servicios.xls";
