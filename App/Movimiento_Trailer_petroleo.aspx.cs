...
public partial class App_Movimiento_Trailer_petroleo : System.Web.UI.Page
{
    ...
    protected void petroleo_checked(object sender, EventArgs e)
    {
        if (petroleo.Checked==true)
        {
            pnl_destino.Visible = false;
            rfv_destinoPos.Enabled = false;
        }
        else
        {
            pnl_destino.Visible = true;
            rfv_destinoPos.Enabled = true;
        }
