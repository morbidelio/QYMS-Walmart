...
public partial class App_soli_devo : System.Web.UI.Page
{
    ...
    private void ObtenerTrailer(bool forzarBD)
    {
        if (this.ViewState["lista"] == null || forzarBD)
        {
            ...
            DataTable dt = trailer.obtenerXParametroDevolucion(this.txt_buscarNombre.Text, this.txt_buscarNro.Text, this.chk_buscarInterno.Checked, int.Parse(this.ddl_buscarTipo.SelectedValue), int.Parse(this.ddl_buscarTransportista.SelectedValue), Convert.ToInt32(this.dropsite.SelectedValue));
