<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Control_DescargaV2.aspx.cs" Inherits="App_Control_Descarga" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gv_listar" runat="server" CellPadding="8" DataKeyNames="ID" UseAccessibleHeader="true"
                  ...
                  <span class="glyphicon glyphicon-screenshot"></span>
                        ...
                        <asp:TemplateField HeaderText="Mover" ShowHeader="False" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" Visible="false"
                            HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                ...
                <ContentTemplate>
                  ...
                  <br />
                                ...
                                <div class="col-xs-6">
                                    Playa
                  <br />
                                    <asp:DropDownList ID="ddl_editPlaya" CssClass="form-control" OnSelectedIndexChanged="ddl_editPlaya_IndexChanged" Enabled="false" runat="server">
                                        <asp:ListItem Value="0" Text="Seleccione..." />
                                    </asp:DropDownList>
                                </div>
                                <div class="col-xs-2">
