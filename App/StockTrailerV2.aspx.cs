...
public partial class App_stockTrailerv2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            utils.CargaDropTodos(ddl_capacidad, "ID", "DESCRIPCION", car.obtenerXTipo(0));
            utils.CargaDropTodos(ddl_tipocarga, "ID", "DESCRIPCION", ct.obtenerTodo());
            utils.CargaDropTodos(ddl_shortec, "SHOR_ID", "SHOR_DESC", sh.ObtenerTodos());
        }
    }
