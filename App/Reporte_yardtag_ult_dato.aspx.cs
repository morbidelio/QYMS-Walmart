...
public partial class App_Reporte_yardtag_ult_dato : System.Web.UI.Page
{
    ...
    protected void btnExportar_Click(object sender, EventArgs e)
    {
        ...
        string fileName = "Reporte_yartag_movimientos.xls";
    ...
    private void ObtenerReporte(bool forzarBD)
    {
        if (this.ViewState["listar"] == null || forzarBD)
        {
            ...
            this.ViewState["listar"] = r.Cargaryardtagultdato(site_id, desde, hasta, txt_placa.Text, ddl_playa.SelectedValue);
        }
