...
<asp:Content ID="Content6" ContentPlaceHolderID="scripts" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function selecciona(elemento,  cambio) {

             if (cambio == undefined) cambio=true;

       //      if (elemento != lugarseleccionado) cambio = true;
        ...
        function drag(e) {
            ...
            updateLastPos();
            selecciona(e.currentTarget,false);
