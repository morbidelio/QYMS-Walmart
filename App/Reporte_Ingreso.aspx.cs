...
public partial class App_Reporte_Ingreso : System.Web.UI.Page
{
    ...
    private void ObtenerReporte(bool forzarBD)
    {
        if (this.ViewState["listar"] == null || forzarBD)
        {
            ...
            int tipo = Convert.ToInt32(this.ddl_tipo.SelectedValue);
            ...
            this.ViewState["listar"] = r.CargarIngresos(site_id, tipo, desde, hasta);
        }
