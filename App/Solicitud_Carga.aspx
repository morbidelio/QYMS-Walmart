<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Solicitud_Carga.aspx.cs" Inherits="App_Solicitud_Carga" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Titulo" ContentPlaceHolderID="titulo" runat="Server">
    <div class="col-xs-12 separador"></div>
    <h2>Solicitud de Ruta
    </h2>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <span class="glyphicon glyphicon-remove" />
                ...
                <asp:LinkButton ID="volver2" CssClass="btn btn-primary" runat="server" ToolTip="Limpiar Datos" OnClick="volver2_click">
            <span class="glyphicon glyphicon-remove" />
                </asp:LinkButton>
            </div>
        </ContentTemplate>
