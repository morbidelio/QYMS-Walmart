...
public partial class App_Control_Carga_New_6009 : System.Web.UI.Page
{
    ...
    protected void gv_listar_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            this.gv_listar.SelectedIndex = Convert.ToInt32(e.CommandArgument);
            sa.SOLI_ID = Convert.ToInt32(this.gv_listar.SelectedDataKey.Values[0]);
            sa.LUGA_ID = Convert.ToInt32(this.gv_listar.SelectedDataKey.Values[1]);
            sa.SOAN_ORDEN = Convert.ToInt32(this.gv_listar.SelectedDataKey.Values[2]);
            sa = sa.ObtenerXId();
        }
        catch (Exception)
        {
        ...
        switch (e.CommandName.ToString())
        {
            ...
            case "encender":
                ...
                solicitud.SOLI_ID = int.Parse(this.hf_soliId.Value);
                resultado="";
    ...
    private void validar_sello()
    {
        ...
        anden.SOLI_ID = int.Parse(this.hf_soliId.Value);
        string resultado;
    ...
    {
        SolicitudBC s = new SolicitudBC();
        s.SOLI_ID = int.Parse(this.hf_soliId.Value);
        string error = "";
    ...
    protected void btn_reanudar_Click(object sender, EventArgs e)
    {
        SolicitudAndenesBC sa = new SolicitudAndenesBC();
        SolicitudBC s = new SolicitudBC();
        s.SOLI_ID = int.Parse(hf_soliId.Value);
