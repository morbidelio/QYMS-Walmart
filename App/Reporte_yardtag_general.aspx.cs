...
public partial class App_Reporte_yardtag_general : System.Web.UI.Page
{
    ...
    protected void btnExportar_Click(object sender, EventArgs e)
    {
        ...
        string fileName = "Reporte_yartag_general.xls";
   ...
   //     this.ObtenerReporte(true);
    ...
    private void ObtenerReporte(bool forzarBD)
    {
        if (this.ViewState["listar"] == null || forzarBD)
        {
            ...
            this.ViewState["listar"] = r.Cargaryardtaggeneral(site_id, desde, hasta,txt_placa.Text, ddl_playa.SelectedValue, ddl_Zona.SelectedValue);
        }
