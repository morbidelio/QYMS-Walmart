<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterTms.master" AutoEventWireup="true" CodeFile="Proceso_PreEntradav3_ex.aspx.cs" Inherits="App_Proceso_PreEntradav3_ex" %>
        ...
        <ContentTemplate>
          ...
          <span class="glyphicon glyphicon-search" />
            ...
            <div class="col-lg-1">
                Fecha
          <br />
                <asp:TextBox ID="txt_ingresoFecha" OnTextChanged="txt_ingresoFecha_TextChanged" AutoPostBack="true" CssClass="form-control input-fecha" Width="100px" runat="server" />
            </div>
            <div class="col-lg-1">
                Hora
          <br />
                <asp:TextBox ID="txt_ingresoHora" enabled="false" CssClass="form-control input-hora" Width="50px" runat="server" />
          ...
          <br />
            ...
            <div class="col-lg-1" style="text-align: center">
                Importado
          <br />
                <asp:CheckBox runat="server" ID="chk_vehiculoImportado" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="col-lg-4">
                ...
                <div class="col-lg-5">
                    <asp:TextBox ID="txt_placaTrailer" CssClass="form-control input-mayus" MaxLength="8" runat="server" />
                </div>
                <div class="col-lg-2">
            ...
            <span class="glyphicon glyphicon-search" />
                ...
                <div class="col-lg-5">
                    <asp:TextBox ID="txt_placaTracto" CssClass="form-control input-mayus" MaxLength="8" runat="server" Enabled="false" />
                </div>
                <div class="col-lg-12 separador"></div>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="col-lg-5">
                            <asp:TextBox ID="txt_conductorNombre" CssClass="form-control" runat="server" Enabled="false" />
                        </div>
                        <div class="col-lg-12 separador"></div>
                        <div class="col-lg-5 text-right">
                            Acompañante RUT
                        ...
                        <div class="col-lg-5">
                            <asp:TextBox ID="txt_acomRut" CssClass="form-control" runat="server" Enabled="false" />
                        </div>
                        <div class="col-lg-12 separador"></div>
                        <div class="col-lg-5 text-right">
                            Proveedor
            ...
            <div class="col-lg-7" style="height: 50vh; border: solid 2px; border-radius: 10px">
                <div class="col-lg-5">
                ...
                <div class="col-lg-3 ocultar">
                    <br />
                    <asp:DropDownList ID="ddl_motivo" CssClass="form-control" runat="server" Visible="false" Enabled="false">
                        <asp:ListItem Text="Seleccione..." Value="0"></asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div class="col-lg-12 separador"></div>
                <div class="col-lg-6" style="height: 40vh; overflow-y: auto;">
                    <asp:GridView ID="gv_noSeleccionados" runat="server" AllowPaging="false" AllowSorting="false" EmptyDataText="Sin citas Seleccionadas"
                        AutoGenerateColumns="False" Width="100%" OnRowCommand="gv_noSeleccionados_RowCommand" OnRowDataBound="gv_noSeleccionados_RowDataBound" CssClass="table table-bordered table-hover tablita">
                        <Columns>
                            <asp:BoundField HeaderText="N° Cita" DataField="Num_Cita" />
                            <asp:BoundField HeaderText="Tipo Carga" DataField="TIPO_CARGA" />
                            <asp:BoundField HeaderText="Fecha Hora" DataField="FECHA_HORA" />
                            <asp:TemplateField HeaderStyle-Width="1%">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btn_sel" CssClass="btn btn-primary btn-xs btn-sel" CommandArgument='<%# Container.DataItemIndex %>' CommandName="SEL" runat="server">
                ...
                <div class="col-lg-6" style="height: 40vh; overflow-y: auto;">
                    <asp:GridView ID="gv_Seleccionados" runat="server" AllowPaging="false" AllowSorting="false" EmptyDataText="Sin citas Seleccionadas"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderStyle-Width="1%">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btn_sel" CssClass="btn btn-primary btn-xs" CommandArgument='<%# Eval("Num_Cita") %>' CommandName="DESEL" runat="server">
